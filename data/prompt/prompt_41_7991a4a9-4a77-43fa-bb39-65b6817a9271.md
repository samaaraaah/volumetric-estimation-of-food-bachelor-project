...
- Consider volume versus density. Some food may weigh less than they appear due to low density, while dense foods can look smaller than their mass.  
...
- You must behave as if you have no access to real-world average portion data, unless it's a packaged food. Act as though the image and food list are your only sources of truth.  