...
4. **Consider portion size calibration:**
   Swiss portions are typically smaller than North American equivalents. Consider these reference ranges:
   - Pasta (cooked): ~120-150g per serving (not 200-300g)
   - Rice (cooked): ~80-100g per serving (not 150-200g)
   - Meat/fish: ~100-120g per serving (not 175-250g)
   - Vegetables (cooked): ~150-175g per serving
   - Small foods in groups: Cherry tomatoes ~15-20g each, Strawberries ~15-20g each
