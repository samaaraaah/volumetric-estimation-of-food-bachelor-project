...
- Avoid assumptions about standard portions unless the item is a processed or packaged food, in which case it's acceptable to use known weights based on standard packaging, even if the packaging is not visible — but you must explicitly state this in your reasoning.  
...
- Large quantities of food may appear compact but contain more mass. When food is piled, layered, or covers a large area of the plate, take into account the implied volume and adjust accordingly. 
...
- Do not use nutritional databases or prior knowledge of standard serving sizes, unless the food is clearly identifiable as a specific processed or packaged product.  
