...
<p align="center">
  <img src="./src/outputs/same_prompt_models_comparison_1.png" alt="Model comparison with same prompt" width="60%"><br>
  <em>Figure 1: Comparison of model outputs using the same prompt on a sample dataset.</em>
</p>
...
I was also curious to compare the performance of GPT-4.1 and its smaller variants, GPT-4.1 mini and GPT-4.1 nano. The full GPT-4.1 model performed significantly better, with a Weighted MAE more than 20 g lower than that of GPT-4.1 nano.

<p align="center">
  <img src="./src/outputs/same_prompt_models_comparison_3.png" alt="Model comparison with same prompt" width="60%"><br>
