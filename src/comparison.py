...
def load_data(args):
    ...
    if args.liquid:
        ...
        csv_file = "../data/cleaned/weight_data_cleaned_no_liquid.csv" if args.wholedata else "../data/cleaned/weight_data_cleaned_sample_20250604.csv" # To modify depending on the sample being evaluated
