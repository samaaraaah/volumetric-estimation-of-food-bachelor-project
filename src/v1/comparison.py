...
if args.sample:
    csv_file = "../../data/v1/weight_data_sample.csv"
else:
    csv_file = "../../data/weight_data.csv"

json_file = f"../../data/v1/result_data/{args.json}"  
...
output_filename = f"../../data/v1/comparison_data/comparison_{args.json.split('.')[0]}.csv"
...
sorted_df.to_csv(f"../../data/v1/comparison_data/sorted_{args.json.split('.')[0]}.csv", index=False, columns=["key", "description", "weight", "predicted_weight", "absolute_error", "weighed_absolute_error", "url"])
